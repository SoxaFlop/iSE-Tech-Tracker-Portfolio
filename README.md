# iSE Tech Tracker — Portfolio Edition

A separate, sanitised portfolio edition derived from the private `iSE-Tech-Tracker` project. The application itself uses generic demonstration branding while retaining the full-stack architecture and engineering patterns. It contains no production credentials, customer records, company artwork, deployment links or inherited Git history.
